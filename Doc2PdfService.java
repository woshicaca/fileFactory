...
@Service("doc")
public class Doc2PdfService implements FileFactory {

    private static final Logger log = LoggerFactory.getLogger(Doc2PdfService.class);
    ...
    public void filePreview(String source,String md5,OutputStream outputStream, HttpServletResponse response) throws Exception {
        ...
        response.setHeader("Content-Disposition",
            "attachment; filename=\"" + URLEncoder.encode(downloadName.substring(0,downloadName.lastIndexOf("."))+".jpeg","UTF-8")+ "\"");
     ...
     * 无授权的文件有水印和试用标记
     */
    public static boolean isWordLicense() throws Exception {
